...
namespace RedSpiceBot.ArtifactGenerator
{
	...
	/// </summary>
	public sealed class MarkovChainsArtifactGenerator
	{
		#region Fields
		...
		public MarkovChainsArtifactGenerator(Random random = null, int mapDepth = DefaultDepth,
		...
		public MarkovChainsArtifactGenerator(MarkovChainMap<string> map, Random random = null,
			int minFrequency = DefaultMinFrequency, int minLength = DefaultMinLength, int maxLength = DefaultMaxLength,
			bool capitalize = true, bool skipWhitespace = true, IEnumerable<string> blacklistedNames = null)
